...
@php
    ...
    // CIDs generados en el mailable y pasados a la vista
    $headerCid   = $headerCid   ?? null;   // header.png
    $opLogoCid   = $opLogoCid   ?? null;   // p.ej. "IM LOGISTICA.png"
@endphp
    ...
    <tr>
      <td align="center" style="padding:24px 12px;">
        <table class="container" role="presentation" width="600" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td>
              <img src="{{ $headerCid }}" alt="IM Ingeniería" class="header-img"
          ...
          <tr>
            <td class="px" style="padding:24px 32px 8px 32px;">
              <h1 style="margin:0 0 12px 0;font-family:Arial,Helvetica,sans-serif;font-size:22px;color:#0b3677;">
                Ayúdanos a mejorar juntos: Encuesta de satisfacción IM Ingeniería
              </h1>
            </td>
          </tr>
          ...
          <tr>
            <td class="px" style="padding:0 32px 24px 32px;">
              ...
              <p style="margin:0 0 12px 0;font-family:Arial,Helvetica,sans-serif;font-size:15px;color:#2b2b2b;">
                Hola <strong>{{ $safeName }}</strong>,
              </p>

              <p style="margin:0 0 12px 0;font-family:Arial,Helvetica,sans-serif;font-size:15px;color:#2b2b2b;line-height:1.6;">
                        ...
                        <tr>
                          @if($opLogoCid)
                            <td width="190" valign="top" style="padding-right:12px;">
                              <img src="{{ $opLogoCid }}" alt="IM {{ ucfirst($op) }}" class="op-logo"
                                   style="display:block;width:190px;max-width:100%;height:auto;border:0;">
                            </td>
                          @endif
                          <td valign="top">
                            @if($opMessage)
                              <p style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:15px;color:#0b2a66;line-height:1.6;">
                                {{ $opMessage }}
                              </p>
                            @endif
                          </td>
              ...
              <p style="margin:0 0 16px 0;font-family:Arial,Helvetica,sans-serif;font-size:15px;color:#2b2b2b;">
              ...
              <p style="margin:0 0 0 0;font-family:Arial,Helvetica,sans-serif;font-size:15px;color:#2b2b2b;">
