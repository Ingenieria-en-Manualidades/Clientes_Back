                      ...
                      <tr>
                        @if(!empty($opLogoPath) && is_file($opLogoPath))
                          <td width="190" valign="top" style="padding-right:12px;">
                            <img src="{{ $message->embed($opLogoPath) }}" alt="IM {{ ucfirst(str_replace('_',' ',$op)) }}" class="op-logo" style="display:block;width:190px;max-width:100%;height:auto;">
                          </td>
                        @elseif($opPublicFile)
                          <td width="190" valign="top" style="padding-right:12px;">
                            <img src="{{ $publicBase }}/{{ $opPublicFile }}" alt="IM {{ ucfirst(str_replace('_',' ',$op)) }}" class="op-logo" style="display:block;width:190px;max-width:100%;height:auto;">
                          </td>
                        @endif
